...
<head>
  ...
  <title>Installation &mdash; gnosis.js  documentation</title>
...
<li class="toctree-l3"><a class="reference internal" href="#setting-up-a-project-using-npm">Setting up a project using npm</a></li>
<li class="toctree-l3"><a class="reference internal" href="#browser-use">Browser use</a></li>
<li class="toctree-l3"><a class="reference internal" href="#integration-with-webpack-projects-advanced">Integration with webpack projects (advanced)</a></li>
<li class="toctree-l3"><a class="reference internal" href="#setting-up-an-ethereum-json-rpc">Setting up an Ethereum JSON RPC</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#ganache-cli-and-private-chain-providers">Ganache-cli and private chain providers</a></li>
<li class="toctree-l4"><a class="reference internal" href="#metamask">MetaMask</a></li>
</ul>
</li>
</ul>
</li>
...
<li><p class="first">Install <code class="docutils literal notranslate"><span class="pre">gnosis.js</span></code> into your project as a dependency using:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">npm</span> <span class="n">install</span> <span class="o">--</span><span class="n">save</span> <span class="nd">@gnosis</span><span class="o">.</span><span class="n">pm</span><span class="o">/</span><span class="n">gnosisjs</span>
</pre></div>
</div>
<p>Be sure to issue this command with this exact spelling.</p>
<p>This command installs the Gnosis JavaScript library and its dependencies into the <code class="docutils literal notranslate"><span class="pre">node_modules</span></code> directory. The <a class="reference external" href="https://www.npmjs.com/package/&#64;gnosis.pm/gnosisjs"><code class="docutils literal notranslate"><span class="pre">&#64;gnosis.pm/gnosisjs</span></code></a> package contains the following:</p>
<ul class="simple">
<li>ES6 source of the library in <code class="docutils literal notranslate"><span class="pre">src</span></code> which can also be found on the <a class="reference external" href="https://github.com/gnosis/gnosis.js">repository</a></li>
...
<li>Webpacked standalone <code class="docutils literal notranslate"><span class="pre">gnosis[.min].js</span></code> files ready for use by web clients in the <code class="docutils literal notranslate"><span class="pre">dist</span></code> directory</li>
<li>API documentation in the <code class="docutils literal notranslate"><span class="pre">docs</span></code> directory</li>
</ul>
</li>
</ol>
<p>Notice that the library refers to the <code class="docutils literal notranslate"><span class="pre">dist/index</span></code> module as the <code class="docutils literal notranslate"><span class="pre">package.json</span></code> main. This is because even though Node.js does support many new JavaScript features, it natively does not support the use of ES6 imports yet (see <a class="reference external" href="https://github.com/nodejs/help/issues/53">this issue</a>), so the modules are transpiled with <a class="reference external" href="https://babeljs.io/">Babel</a> for Node interoperability.</p>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">Gnosis</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;@gnosis.pm/gnosisjs&#39;</span><span class="p">)</span>
</pre></div>
</div>
...
<p>If you are playing around with gnosis.js directly in the project folder, you can import it from dist</p>
...
<p>The <code class="docutils literal notranslate"><span class="pre">gnosis.js</span></code> file and its minified version <code class="docutils literal notranslate"><span class="pre">gnosis.min.js</span></code> are self-contained and can be used directly in a webpage. For example, you may copy <code class="docutils literal notranslate"><span class="pre">gnosis.min.js</span></code> into a folder or onto your server, and in an HTML page, use the following code to import the library:</p>
<div class="highlight-html notranslate"><div class="highlight"><pre><span></span><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;gnosis.min.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
...
<p>The ES6 source can also be used directly with webpack projects. Please refer to the Babel transpilation settings in <a class="reference external" href="https://github.com/gnosis/gnosis.js/blob/master/.babelrc"><code class="docutils literal notranslate"><span class="pre">.babelrc</span></code></a> and the webpack configuration in <a class="reference external" href="https://github.com/gnosis/gnosis.js/blob/master/webpack.config.js"><code class="docutils literal notranslate"><span class="pre">webpack.config.js</span></code></a> to see what may be involved.</p>
</div>
...
<p>Gnosis.js refers to Truffle contract build artifacts found in <code class="docutils literal notranslate"><span class="pre">node_modules/&#64;gnosis.pm/gnosis-core-contracts/build/contracts/</span></code>, which contain a registry of where key contracts are deployed given a network ID. By default Gnosis contract suite is already deployed on the Ropsten, Kovan, and Rinkeby testnets.</p>
...
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span><span class="o">(</span><span class="nb">cd</span> node_modules/<span class="se">\@</span>gnosis.pm/gnosis-core-contracts/ <span class="o">&amp;&amp;</span> truffle migrate<span class="o">)</span>
</pre></div>
</div>
<p>This will deploy the contracts onto the chain and will record the deployed addresses in the contract build artifacts. This will make the API available to Gnosis.js applications which use the transpiled <em>modules</em> in <code class="docutils literal notranslate"><span class="pre">dist</span></code> (typically Node.js apps), as these modules refer directly to the build artifacts in the <code class="docutils literal notranslate"><span class="pre">&#64;gnosis.pm/gnosis-core-contracts</span></code> package. However, for browser applications which use the standalone library file <code class="docutils literal notranslate"><span class="pre">gnosis[.min].js</span></code>, that file has to be rebuilt to incorporate the new deployment addresses info.</p>
</div>
...
<p><a class="reference external" href="https://metamask.io/">MetaMask</a> is a Chrome browser plugin which injects an instrumented instance of Web3.js into the page. It comes preloaded with connections to the Ethereum mainnet as well as the Ropsten, Kovan, and Rinkeby testnets through <a class="reference external" href="https://infura.io/">Infura</a>. Gnosis.js works out-of-the-box with MetaMask configured to connect to these testnets. Make sure your web page is being <a class="reference external" href="https://github.com/MetaMask/faq/blob/master/DEVELOPERS.md">served over HTTP/HTTPS</a> and uses the standalone library file.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="developer-guide.html" class="btn btn-neutral" title="Developer Guide" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left"></span> Previous</a>
