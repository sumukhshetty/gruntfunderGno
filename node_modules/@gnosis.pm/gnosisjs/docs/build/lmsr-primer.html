...
<head>
  ...
  <title>LMSR Primer &mdash; gnosis.js  documentation</title>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">LMSR Primer</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#bounded-loss-from-the-b-parameter">Bounded Loss from the \(b\) Parameter</a></li>
<li class="toctree-l3"><a class="reference internal" href="#marginal-price-of-outcome-tokens">Marginal Price of Outcome Tokens</a></li>
<li class="toctree-l3"><a class="reference internal" href="#lmsr-calculation-functions">LMSR Calculation Functions</a></li>
</ul>
</li>
</ul>
</li>
...
<p>The Gnosis.js implementation of the logarithmic market scoring rule mostly follows the <a class="reference external" href="http://mason.gmu.edu/~rhanson/mktscore.pdf">original specification</a>. It is based on the following cost function:</p>
