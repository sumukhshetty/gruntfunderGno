...
<head>
  ...
  <title>Events, Oracles and Markets &mdash; gnosis.js  documentation</title>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Events, Oracles and Markets</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#questions-about-the-future-oracles-and-trust">Questions About the Future, Oracles, and Trust</a></li>
<li class="toctree-l3"><a class="reference internal" href="#events-and-collateral">Events and Collateral</a></li>
<li class="toctree-l3"><a class="reference internal" href="#markets-and-automated-market-makers">Markets and Automated Market Makers</a></li>
<li class="toctree-l3"><a class="reference internal" href="#events-with-scalar-outcomes">Events with Scalar Outcomes</a></li>
</ul>
</li>
...
<p>Of course, future events will come to pass, and once they do, the outcome should be determinable. Oracles report on the outcome of events. The simplest oracle contract provided by Gnosis is a <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/CentralizedOracle/"><code class="docutils literal notranslate"><span class="pre">CentralizedOracle</span></code></a>, and it is controlled by a single entity: the <code class="docutils literal notranslate"><span class="pre">owner</span></code> of the contract, which is a single Ethereum address, and which will from this point forward in this guide be referred to as the centralized oracle itself.</p>
...
<p>By no means is the CentralizedOracle the only possible oracle design which can be used with Gnosis. Any oracle which implements the <a class="reference external" href="https://github.com/gnosis/gnosis-contracts/blob/master/contracts/Oracles/Oracle.sol"><code class="docutils literal notranslate"><span class="pre">Oracle</span></code></a> contract interface may be used.</p>
</div>
...
<blockquote>
<div><p>If you are using the Rinkeby network, you can check that your event has been indexed by <a class="reference external" href="https://github.com/gnosis/gnosisdb">GnosisDB</a> with the following URL:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">https</span><span class="p">:</span><span class="o">//</span><span class="n">gnosisdb</span><span class="o">.</span><span class="n">rinkeby</span><span class="o">.</span><span class="n">gnosis</span><span class="o">.</span><span class="n">pm</span><span class="o">/</span><span class="n">api</span><span class="o">/</span><span class="n">events</span><span class="o">/</span><span class="n">EVENT_ADDRESS</span>
</pre></div>
</div>
...
<p>If you are a stakeholder in this <code class="docutils literal notranslate"><span class="pre">event</span></code> contract instance, you can redeem your winnings with <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/CategoricalEvent/"><code class="docutils literal notranslate"><span class="pre">CategoricalEvent.redeemWinnings</span></code></a>:</p>
...
<p>Gnosis contracts contain market and market maker contract interfaces, a <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarket/">standard market implementation</a>, and an <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/LMSRMarketMaker/">implementation</a> of the <a class="reference external" href="http://mason.gmu.edu/~rhanson/mktscore.pdf">logarithmic market scoring rule (LMSR)</a>, an automated market maker. This can be leveraged with the <a class="reference external" href="api-reference.html#createMarket">Gnosis.createMarket</a> method. For example, given an <code class="docutils literal notranslate"><span class="pre">event</span></code>, you can create a <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarket/"><code class="docutils literal notranslate"><span class="pre">StandardMarket</span></code></a> operated by the LMSR market maker with the following:</p>
...
<p>Let’s say now that you’ve decided that these outcome tokens are worth it. Gnosis.js contains convenience functions for buying and selling outcome tokens from a market backed by an LMSR market maker. They are <a class="reference external" href="api-reference.html#buyOutcomeTokens">Gnosis.buyOutcomeTokens</a> and <a class="reference external" href="api-reference.html#sellOutcomeTokens">Gnosis.sellOutcomeTokens</a>. To buy these outcome tokens, you can use the following code:</p>
...
<p>Similarly, you can see how much these outcome tokens are worth to the <code class="docutils literal notranslate"><span class="pre">market</span></code> with <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/LMSRMarketMaker/"><code class="docutils literal notranslate"><span class="pre">LMSRMarketMaker.calcProfit</span></code></a>:</p>
...
<p>Finally, if you are the creator of a <a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarket/"><code class="docutils literal notranslate"><span class="pre">StandardMarket</span></code></a>, you can close the market and obtain all of its outcome token holdings with <code class="docutils literal notranslate"><span class="pre">StandardMarket.close</span></code> and/or withdraw the trading fees paid with <code class="docutils literal notranslate"><span class="pre">StandardMarket.withdrawFees</span></code>:</p>
