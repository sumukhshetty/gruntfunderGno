...
<head>
  ...
  <title>API Reference &mdash; gnosis.js  documentation</title>
...
<dd><p>Represents the gnosis.js API</p>
...
<ul class="simple">
<li>Math (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/Math">https://gnosis.github.io/gnosis-contracts/docs/Math</a>)</li>
<li>Event (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/Event">https://gnosis.github.io/gnosis-contracts/docs/Event</a>)</li>
<li>CategoricalEvent (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/CategoricalEvent">https://gnosis.github.io/gnosis-contracts/docs/CategoricalEvent</a>)</li>
<li>ScalarEvent (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/ScalarEvent">https://gnosis.github.io/gnosis-contracts/docs/ScalarEvent</a>)</li>
<li>EventFactory (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/EventFactory">https://gnosis.github.io/gnosis-contracts/docs/EventFactory</a>)</li>
<li>Token (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/Token">https://gnosis.github.io/gnosis-contracts/docs/Token</a>)</li>
<li>HumanFriendlyToken (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/HumanFriendlyToken">https://gnosis.github.io/gnosis-contracts/docs/HumanFriendlyToken</a>)</li>
<li>EtherToken (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/EtherToken">https://gnosis.github.io/gnosis-contracts/docs/EtherToken</a>)</li>
<li>CentralizedOracle (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/CentralizedOracle">https://gnosis.github.io/gnosis-contracts/docs/CentralizedOracle</a>)</li>
<li>CentralizedOracleFactory (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/CentralizedOracleFactory">https://gnosis.github.io/gnosis-contracts/docs/CentralizedOracleFactory</a>)</li>
<li>UltimateOracle (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/UltimateOracle">https://gnosis.github.io/gnosis-contracts/docs/UltimateOracle</a>)</li>
<li>UltimateOracleFactory (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/UltimateOracleFactory">https://gnosis.github.io/gnosis-contracts/docs/UltimateOracleFactory</a>)</li>
<li>LMSRMarketMaker (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/LMSRMarketMaker">https://gnosis.github.io/gnosis-contracts/docs/LMSRMarketMaker</a>)</li>
<li>Market (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/Market">https://gnosis.github.io/gnosis-contracts/docs/Market</a>)</li>
<li>StandardMarket (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarket">https://gnosis.github.io/gnosis-contracts/docs/StandardMarket</a>)</li>
<li>StandardMarketFactory (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarketFactory">https://gnosis.github.io/gnosis-contracts/docs/StandardMarketFactory</a>)</li>
<li>OlympiaToken (<a class="reference external" href="https://github.com/gnosis/olympia-token">https://github.com/gnosis/olympia-token</a>)</li>
</ul>
<p>These are configured to use the web3 provider specified in Gnosis.create or subsequently modified with Gnosis.setWeb3Provider. The default gas costs for these abstractions are set to the maximum cost of their respective entries found in the <cite>gas-stats.json</cite> file built from the core contracts (<a class="reference external" href="https://github.com/gnosis/gnosis-contracts#readme">https://github.com/gnosis/gnosis-contracts#readme</a>). Additionally, the default message sender (i.e. <cite>from</cite> address) is set via the optional <cite>defaultAccount</cite> param in Gnosis.setWeb3Provider.</p>
</dd></dl>
...
<tr class="field-even field"><th class="field-name">Returns:</th><td class="field-body"><p class="first last"><strong>Gnosis</strong> – An instance of the gnosis.js API</p>
</td>
</tr>
</tbody>
</table>
...
<dd><p>If on mainnet, this will be an EtherToken contract abstraction pointing to the MakerDAO WETH contract (<a class="reference external" href="https://etherscan.io/address/0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2#code">https://etherscan.io/address/0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2#code</a>).</p>
<p>Otherwise, if EtherToken (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/EtherToken/">https://gnosis.github.io/gnosis-contracts/docs/EtherToken/</a>) is deployed to the current network, this will be set to an EtherToken contract abstraction pointing at the deployment address.</p>
</dd></dl>
...
<dd><p>If LMSRMarketMaker (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/LMSRMarketMaker/">https://gnosis.github.io/gnosis-contracts/docs/LMSRMarketMaker/</a>) is deployed to the current network, this will be set to an LMSRMarketMaker contract abstraction pointing at the deployment address.</p>
</dd></dl>

<dl class="attribute">
<dt id="Gnosis.olympiaAddressRegistry">
<code class="descclassname">Gnosis.</code><code class="descname">olympiaAddressRegistry</code><a class="headerlink" href="#Gnosis.olympiaAddressRegistry" title="Permalink to this definition">¶</a></dt>
<dd><p>If AddressRegistry (<a class="reference external" href="https://github.com/gnosis/olympia-token">https://github.com/gnosis/olympia-token</a>) is deployed to the current network (this should only work for Rinkeby), this will be set to an AddressRegistry contract abstraction pointing at the deployment address. This is intended for use with Olympia.</p>
</dd></dl>

<dl class="attribute">
<dt id="Gnosis.olympiaToken">
<code class="descclassname">Gnosis.</code><code class="descname">olympiaToken</code><a class="headerlink" href="#Gnosis.olympiaToken" title="Permalink to this definition">¶</a></dt>
<dd><p>If OlympiaToken (<a class="reference external" href="https://github.com/gnosis/olympia-token">https://github.com/gnosis/olympia-token</a>) is deployed to the current network (this should only work for Rinkeby), this will be set to an OlympiaToken contract abstraction pointing at the deployment address.</p>
</dd></dl>
...
<dd><p>If StandardMarketFactory (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarketFactory/">https://gnosis.github.io/gnosis-contracts/docs/StandardMarketFactory/</a>) is deployed to the current network, this will be set to an StandardMarketFactory contract abstraction pointing at the deployment address.</p>
</dd></dl>
...
<dd><p>Estimates the cost of buying specified number of outcome tokens from LMSR market.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
...
<dd><p>Estimates the marginal price of outcome token.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
...
<dd><p>Estimates profit from selling specified number of outcome tokens to LMSR market.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
...
<tr class="field-even field"><th class="field-name">Returns:</th><td class="field-body"><p class="first last"><strong>Contract</strong> – The created market contract instance. If marketFactory is StandardMarketFactory (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarketFactory/">https://gnosis.github.io/gnosis-contracts/docs/StandardMarketFactory/</a>), this should be a StandardMarket (<a class="reference external" href="https://gnosis.github.io/gnosis-contracts/docs/StandardMarket/">https://gnosis.github.io/gnosis-contracts/docs/StandardMarket/</a>)</p>
</td>
</tr>
</tbody>
</table>
